...
namespace PK_Proyect.ViewModels
{
    public class AdminMenuViewModel : INotifyPropertyChanged
    {
        ...
        // Evento para que la vista cierre sesión
        ...
        public AdminMenuViewModel(User usuario)
        {
            ...
            VerMedallasCommand = new RelayCommand(_ => Pendiente("Medallas del usuario"));
        ...
        private void VerEquipoPokemon()
        {
            ...
            // Crear el ViewModel con el ID del usuario seleccionado
